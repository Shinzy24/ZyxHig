...
inp = ("[-]")
bulat = ("[#]")
logo = (f"""{C} ____  _     _             _____
/ ___|| |__ (_)_ __ __  __|__  /   _
\___ \| '_ \| | '_' \ \/ /  / / | | |
 ___) | | | | | | | |>  <  / /| |_| |                      |____/|_| |_|_|_| |_/_/\_\/____\__, |                                                     |___/{Q}
[+] {I}Athour    : M.ZAINUL UMAM{Q}
[+] {I}WhatsApp  : 6285740559154{Q}""")
loop = 0
ok = []
cp = []
ttl = []
...
def menu():
	...
	print (logo)
	print("[+] ACTIVE USERS : "+nama)
	print("[+] IP DEVICE    : "+ip)
	print("[+] YOUR COUNTRY : "+kiky+"\n")
	print(C+"["+P+"01"+C+"]"+P+" Dump Id Dari Friends/Public")
	print(C+"["+P+"02"+C+"]"+P+" Dump Id Dari followers")
	print(C+"["+P+"03"+C+"]"+P+" Dump Id Dari Friends + public + Follow")
	print(C+"["+P+"04"+C+"]"+P+" Dump Id Dari Friends + followers + Old (Brutal)")
	print(M+"["+P+"05"+M+"]"+P+" START CRACK")
